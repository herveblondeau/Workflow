...
namespace Infrastructure.Tools.Watermarking;
...
public class PdfWatermarker
{
    ...
    private static void AddVisibleWatermark(PdfReader reader, PdfStamper stamper, string text, WatermarkOptions options)
    {
