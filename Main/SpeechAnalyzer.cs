...
public class SpeechAnalyzer
{
    ...
    public void UseRecorder(IRecorder recorder)
    {
        _recorder = recorder;
    }

    public void UseTranscriber(ITranscriber transcriber)
    {
        _transcriber = transcriber;
    }

    public void UseChatAgent(ChatAgent chatAgent)
    {
    ...
    public async Task Process(TranscriptionSource source, string sourceLanguage, bool cleanUp, bool concise, List<string>? additionalInstructions = null, string? targetLanguage = null)
    {
        ...
        // }
        var recordedBytes = await _recorder.Stop();
        ...
        File.WriteAllBytes(outputAudioFile, recordedBytes);
        ...
        var transcription = await _transcriber.Transcribe(File.OpenRead(outputAudioFile), sourceLanguage);
